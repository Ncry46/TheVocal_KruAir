...
export default function Students() {
    ...
    const load = () => api.getStudents().then(setRows).catch((err) => {
        setRows([]);
        toast(err instanceof Error ? err.message : (language === 'en' ? 'Could not load students' : 'โหลดรายชื่อนักเรียนไม่สำเร็จ'));
    });
