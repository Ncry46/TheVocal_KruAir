      ...
      <Card title="ตารางสอน · สัปดาห์ 18–24 ส.ค. 2569">
        <div className="cal-wrap">
          ...
          {WEEK_DAYS.map((day, i) => {
            ...
            const today = day === 'อ.';
            return (<div key={day} className={`cal-day-head ${today ? 'today' : ''}`}>
          ...
          {TIMES.map((time) => (<div key={time} className="cal-row">
              ...
              {WEEK_DAYS.map((day) => {
                ...
                return (<div key={day} className={`cal-cell ${slotData ? 'has-data' : ''} ${isActive ? 'selected' : ''}`} onClick={() => handleCellClick(day, time)}>
